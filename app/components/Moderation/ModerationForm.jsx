    ...
    return (
      <div>
        ...
        <div className="buttons field is-grouped">
          <a className="button" disabled={!flagReason} onClick={this.getSubmit(MODERATION_ACTION_ABUSIVE)}>
            <span>{t("actions.flag_abusive")}</span>
          </a>
          <a className="button" disabled={!flagReason} onClick={this.getSubmit(MODERATION_ACTION_NOTSURE)}>
            <span>{t("actions.unsure")}</span>
          </a>
          <a className="button" disabled={!flagReason} onClick={this.getSubmit(MODERATION_ACTION_CONFIRM)}>
