...
export class StatementForm extends React.PureComponent {
  ...
  toggleLock() {
    if (this.state.lockedTime === false) this.setState({ lockedTime: this.props.position || 0 })
  ...
  handleSubmit(statement) {
    ...
    if (currentTime !== 0 && !currentTime) statement.time = this.props.initialValues.time || 0
