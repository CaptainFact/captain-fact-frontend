...
@translate('user')
@connect(null, {resetPasswordRequest, resetPasswordVerify, resetPasswordConfirm, login})
export default class ResetPasswordConfirmForm extends React.PureComponent {
  ...
  submitForm(e) {
    this.props.resetPasswordConfirm({
      ...
      onSuccess: () => {
        this.props.login({provider: 'identity', params: {email: this.state.payload.email, password: e.password}})
