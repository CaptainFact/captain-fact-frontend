...
export type Flag = {
  __typename?: 'Flag';
  /** Reason for the flag */
  reason?: Maybe<FlagReason>;
  /** User who created the flag */
  sourceUser?: Maybe<User>;
};

/** Reason for flagging a comment */
export enum FlagReason {
  ...
  /** Not constructive */
  NotConstructive = 'NOT_CONSTRUCTIVE',
  /** Unwanted commercial content or spam */
  Spam = 'SPAM'
}

/** A moderation entry containing an action and its flags */
export type ModerationEntry = {
  __typename?: 'ModerationEntry';
  /** The action that needs moderation */
  action: UserAction;
  /** Flags associated with this action */
  flags: Array<Maybe<Flag>>;
};

/** Reference to a moderated action */
export type ModerationFeedback = {
  __typename?: 'ModerationFeedback';
  id: Scalars['ID']['output'];
};
...
export type RootMutationType = {
  ...
  /** Create a new video. If it already exists, returns the existing video. */
  ...
  /** Moderate a flagged action */
  moderateAction?: Maybe<ModerationFeedback>;
...
export type RootMutationTypeModerateActionArgs = {
...
export type RootQueryType = {
  ...
  /** Get a random action requiring moderation */
  randomModeration?: Maybe<ModerationEntry>;
  /** Search for speakers by name */
  searchSpeakers?: Maybe<Array<Maybe<Speaker>>>;
  /** Search for a video by URL. Returns the video if it exists, null otherwise. */
  searchVideo?: Maybe<Video>;
...
export type RootQueryTypeSearchVideoArgs = {
  url: Scalars['String']['input'];
};
...
export type User = {
  ...
  /** User's flags on comments as a map (commentId => true) for the given video */
...
export type CreateVideoMutation = { __typename?: 'RootMutationType', createVideo?: { __typename?: 'Video', id: string, hashId: string, title: string, url: string, unlisted: boolean } | null };
...
export type SearchVideoQuery = { __typename?: 'RootQueryType', searchVideo?: { __typename?: 'Video', id: string, hashId: string, title: string, url: string, unlisted: boolean } | null };
...
export type ModerateActionMutation = { __typename?: 'RootMutationType', moderateAction?: { __typename?: 'ModerationFeedback', id: string } | null };

export type RandomModerationQueryVariables = Exact<{ [key: string]: never; }>;


export type RandomModerationQuery = { __typename?: 'RootQueryType', randomModeration?: { __typename?: 'ModerationEntry', action: { __typename?: 'UserAction', id: string, type: string, entity: string, changes?: string | null, time?: string | null, speakerId?: number | null, statementId?: number | null, commentId?: number | null, videoId?: number | null, videoHashId?: string | null, user?: { __typename?: 'User', id: string, username: string, name?: string | null, pictureUrl: string, miniPictureUrl: string } | null }, flags: Array<{ __typename?: 'Flag', reason?: FlagReason | null, sourceUser?: { __typename?: 'User', id: string, username: string, name?: string | null, pictureUrl: string, miniPictureUrl: string } | null } | null> } | null };
...
export type SpeakerFieldsFragment = { __typename?: 'Speaker', id: string, fullName: string, slug?: string | null, picture?: string | null, title?: string | null };
...
export type AddSpeakerToVideoMutation = { __typename?: 'RootMutationType', addSpeakerToVideo?: { __typename?: 'Speaker', id: string, fullName: string, slug?: string | null, picture?: string | null, title?: string | null } | null };
...
export type CreateSpeakerMutation = { __typename?: 'RootMutationType', createSpeaker?: { __typename?: 'Speaker', id: string, fullName: string, slug?: string | null, picture?: string | null, title?: string | null } | null };
...
export type VideoDebateQuery = { __typename?: 'RootQueryType', video?: { __typename?: 'Video', id: string, hashId: string, title: string, url: string, thumbnail: string, language?: string | null, unlisted: boolean, youtubeOffset: number, youtubeId?: string | null, speakers?: Array<{ __typename?: 'Speaker', id: string, fullName: string, title?: string | null, wikidataItemId?: string | null, slug?: string | null, picture?: string | null } | null> | null, statements?: Array<{ __typename?: 'Statement', id: string, text: string, time: number, isDraft: boolean, speaker?: { __typename?: 'Speaker', id: string, fullName: string, title?: string | null, wikidataItemId?: string | null, slug?: string | null, picture?: string | null } | null, comments?: Array<{ __typename?: 'Comment', id: string, text?: string | null, approve?: boolean | null, score: number, insertedAt: string, replyToId?: string | null, statementId?: string | null, user?: { __typename?: 'User', id: string, username: string, pictureUrl: string, miniPictureUrl: string, speakerId?: string | null } | null, source?: { __typename?: 'Source', id: string, url: string, title?: string | null, siteName?: string | null } | null } | null> | null } | null> | null } | null, loggedInUser?: { __typename?: 'User', id: string, votes?: any | null, flags?: any | null, subscriptions?: Array<{ __typename?: 'NotificationsSubscription', isSubscribed: boolean } | null> | null } | null };

export type VideoDebateStatementAddedSubscriptionVariables = Exact<{
  videoId: Scalars['ID']['input'];
}>;


export type VideoDebateStatementAddedSubscription = { __typename?: 'RootSubscriptionType', statementAdded?: { __typename?: 'Statement', id: string, text: string, time: number, isDraft: boolean, video?: { __typename?: 'Video', id: string } | null, speaker?: { __typename?: 'Speaker', id: string, fullName: string, title?: string | null, wikidataItemId?: string | null, slug?: string | null, picture?: string | null } | null, comments?: Array<{ __typename?: 'Comment', id: string, text?: string | null, approve?: boolean | null, score: number, insertedAt: string, replyToId?: string | null, statementId?: string | null, user?: { __typename?: 'User', id: string, username: string, pictureUrl: string, miniPictureUrl: string, speakerId?: string | null } | null, source?: { __typename?: 'Source', id: string, url: string, title?: string | null, siteName?: string | null } | null } | null> | null } | null };

export type VideoDebateStatementUpdatedSubscriptionVariables = Exact<{
  videoId: Scalars['ID']['input'];
}>;


export type VideoDebateStatementUpdatedSubscription = { __typename?: 'RootSubscriptionType', statementUpdated?: { __typename?: 'Statement', id: string, text: string, time: number, isDraft: boolean, video?: { __typename?: 'Video', id: string } | null, speaker?: { __typename?: 'Speaker', id: string, fullName: string, title?: string | null, wikidataItemId?: string | null, slug?: string | null, picture?: string | null } | null, comments?: Array<{ __typename?: 'Comment', id: string, text?: string | null, approve?: boolean | null, score: number, insertedAt: string, replyToId?: string | null, statementId?: string | null, user?: { __typename?: 'User', id: string, username: string, pictureUrl: string, miniPictureUrl: string, speakerId?: string | null } | null, source?: { __typename?: 'Source', id: string, url: string, title?: string | null, siteName?: string | null } | null } | null> | null } | null };

export type VideoDebateStatementRemovedSubscriptionVariables = Exact<{
  videoId: Scalars['ID']['input'];
}>;


export type VideoDebateStatementRemovedSubscription = { __typename?: 'RootSubscriptionType', statementRemoved?: { __typename?: 'StatementRemoved', id: string } | null };

export type VideoDebateCommentAddedSubscriptionVariables = Exact<{
  videoId: Scalars['ID']['input'];
}>;


export type VideoDebateCommentAddedSubscription = { __typename?: 'RootSubscriptionType', commentAdded?: { __typename?: 'Comment', id: string, text?: string | null, approve?: boolean | null, score: number, insertedAt: string, replyToId?: string | null, statementId?: string | null, user?: { __typename?: 'User', id: string, username: string, pictureUrl: string, miniPictureUrl: string, speakerId?: string | null } | null, source?: { __typename?: 'Source', id: string, url: string, title?: string | null, siteName?: string | null } | null } | null };

export type VideoDebateCommentUpdatedSubscriptionVariables = Exact<{
  videoId: Scalars['ID']['input'];
}>;


export type VideoDebateCommentUpdatedSubscription = { __typename?: 'RootSubscriptionType', commentUpdated?: { __typename?: 'Comment', id: string, text?: string | null, approve?: boolean | null, score: number, insertedAt: string, replyToId?: string | null, statementId?: string | null, user?: { __typename?: 'User', id: string, username: string, pictureUrl: string, miniPictureUrl: string, speakerId?: string | null } | null, source?: { __typename?: 'Source', id: string, url: string, title?: string | null, siteName?: string | null } | null } | null };

export type VideoDebateCommentRemovedSubscriptionVariables = Exact<{
  videoId: Scalars['ID']['input'];
}>;


export type VideoDebateCommentRemovedSubscription = { __typename?: 'RootSubscriptionType', commentRemoved?: { __typename?: 'CommentRemoved', id: string, statementId?: string | null, replyToId?: string | null } | null };

export type VideoDebateCommentScoreDiffSubscriptionVariables = Exact<{
  videoId: Scalars['ID']['input'];
}>;


export type VideoDebateCommentScoreDiffSubscription = { __typename?: 'RootSubscriptionType', commentScoreDiff?: { __typename?: 'CommentScoreDiff', diff: number, comment: { __typename?: 'CommentReference', id: string, statementId?: string | null, replyToId?: string | null } } | null };

export type VideoDebateSpeakerAddedSubscriptionVariables = Exact<{
  videoId: Scalars['ID']['input'];
}>;


export type VideoDebateSpeakerAddedSubscription = { __typename?: 'RootSubscriptionType', speakerAdded?: { __typename?: 'Speaker', id: string, fullName: string, title?: string | null, wikidataItemId?: string | null, slug?: string | null, picture?: string | null } | null };

export type VideoDebateSpeakerUpdatedSubscriptionVariables = Exact<{
  videoId: Scalars['ID']['input'];
}>;


export type VideoDebateSpeakerUpdatedSubscription = { __typename?: 'RootSubscriptionType', speakerUpdated?: { __typename?: 'Speaker', id: string, fullName: string, title?: string | null, wikidataItemId?: string | null, slug?: string | null, picture?: string | null } | null };

export type VideoDebateSpeakerRemovedSubscriptionVariables = Exact<{
  videoId: Scalars['ID']['input'];
}>;


export type VideoDebateSpeakerRemovedSubscription = { __typename?: 'RootSubscriptionType', speakerRemoved?: { __typename?: 'SpeakerRemoved', id: string } | null };

export type VideoDebateStartAutomaticStatementsExtractionMutationVariables = Exact<{
  videoId: Scalars['ID']['input'];
}>;


export type VideoDebateStartAutomaticStatementsExtractionMutation = { __typename?: 'RootMutationType', startAutomaticStatementsExtraction?: { __typename?: 'Video', id: string } | null };

export type VideoDebateUpdateSubscriptionMutationVariables = Exact<{
  entityId: Scalars['ID']['input'];
  scope: Scalars['String']['input'];
  isSubscribed: Scalars['Boolean']['input'];
}>;
...
export type VideoDebateUpdateSubscriptionMutation = { __typename?: 'RootMutationType', updateSubscription?: { __typename?: 'NotificationsSubscription', id: string, isSubscribed: boolean, reason?: string | null } | null };
