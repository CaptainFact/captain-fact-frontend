...
export type UserQuery = {
  ...
  user?: {
    ...
    achievements?: Array<number | null> | null
  } | null
}
...
export type LoggedInUserSubscriptionsQuery = {
  ...
  loggedInUser?: {
    ...
    subscriptions?: Array<{
      ...
      video?: { __typename?: 'Video'; hashId: string; title: string } | null
    } | null> | null
  } | null
}
...
export type LoggedInUserUnreadNotificationsCountQuery = {
  ...
  loggedInUser?: {
    __typename?: 'User'
    id: string
    notifications?: { __typename?: 'PaginatedNotifications'; totalEntries?: number | null } | null
  } | null
}

export type LoggedInUserPendingModerationCountQueryVariables = Exact<{ [key: string]: never }>

export type LoggedInUserPendingModerationCountQuery = {
  __typename?: 'RootQueryType'
  loggedInUser?: {
    __typename?: 'User'
    id: string
    actionsPendingModeration?: number | null
  } | null
}
...
export type LoggedInUserTodayReputationGainQuery = {
  __typename?: 'RootQueryType'
  loggedInUser?: { __typename?: 'User'; id: string; todayReputationGain?: number | null } | null
}
...
export type DeleteStatementMutation = {
  __typename?: 'RootMutationType'
  deleteStatement?: { __typename?: 'StatementRemoved'; id: string } | null
}
...
export type CreateCommentMutation = {
  ...
  createComment?: {
    ...
    user?: { __typename?: 'User'; id: string; username: string; pictureUrl: string } | null
    source?: { __typename?: 'Source'; id: string; url: string } | null
  } | null
}
...
export type VoteCommentMutation = {
  __typename?: 'RootMutationType'
  voteComment?: { __typename?: 'Comment'; id: string; score: number } | null
}
...
export type FlagCommentMutation = {
  __typename?: 'RootMutationType'
  flagComment?: { __typename?: 'CommentFlagged'; id: string } | null
}
...
export type RemoveSpeakerFromVideoMutation = {
  __typename?: 'RootMutationType'
  removeSpeakerFromVideo?: { __typename?: 'SpeakerRemoved'; id: string } | null
}
    ...
    notifications?: {
      ...
      entries?: Array<{
        ...
        action?: {
          ...
          video?: { __typename?: 'Video'; id: string; hashId: string; title: string } | null
          speaker?: {
            __typename?: 'Speaker'
            id: string
            slug?: string | null
          ...
          comment?: { __typename?: 'Comment'; id: string; text?: string | null } | null
        } | null
      } | null> | null
    } | null
  } | null
...
export type CreateStatementMutation = {
  ...
  createStatement?: {
    ...
    text: string
    isDraft: boolean
    speaker?: { __typename?: 'Speaker'; id: string } | null
    video?: { __typename?: 'Video'; id: string } | null
  } | null
}
  ...
  user?: {
    ...
    actions?: {
      ...
      entries?: Array<{
        ...
        commentId?: number | null
        speakerId?: number | null
        authorReputationChange?: number | null
        targetReputationChange?: number | null
        userId?: string | null
        targetUserId?: string | null
        user?: { __typename?: 'User'; id: string; username: string; name?: string | null } | null
        targetUser?: {
          __typename?: 'User'
          id: string
          username: string
...
export type VideoDebateSpeakerFieldsFragment = {
  __typename?: 'Speaker'
  id: string
  fullName: string
  title?: string | null
...
export type VideoDebateStatementFieldsFragment = {
  __typename?: 'Statement'
  id: string
  text: string
  time: number
...
export type VideoDebateQuery = {
  ...
  loggedInUser?: { __typename?: 'User'; id: string; votes?: any | null } | null
}
...
export type VideoDebateStatementAddedSubscription = {
  __typename?: 'RootSubscriptionType'
  statementAdded?: {
    __typename?: 'Statement'
    id: string
...
export type VideoDebateStatementUpdatedSubscription = {
  __typename?: 'RootSubscriptionType'
  statementUpdated?: {
    __typename?: 'Statement'
    id: string
...
export type VideoDebateStatementRemovedSubscription = {
  __typename?: 'RootSubscriptionType'
  statementRemoved?: { __typename?: 'StatementRemoved'; id: string } | null
}
...
export type VideoDebateCommentUpdatedSubscription = {
  __typename?: 'RootSubscriptionType'
  commentUpdated?: {
    __typename?: 'Comment'
    id: string
...
export type VideoDebateCommentRemovedSubscription = {
  __typename?: 'RootSubscriptionType'
  commentRemoved?: {
    __typename?: 'CommentRemoved'
    id: string
...
export type VideoDebateCommentScoreDiffSubscription = {
  __typename?: 'RootSubscriptionType'
  commentScoreDiff?: {
    __typename?: 'CommentScoreDiff'
    diff: number
...
export type VideoDebateSpeakerAddedSubscription = {
  __typename?: 'RootSubscriptionType'
  speakerAdded?: {
    __typename?: 'Speaker'
    id: string
...
export type VideoDebateSpeakerUpdatedSubscription = {
  __typename?: 'RootSubscriptionType'
  speakerUpdated?: {
    __typename?: 'Speaker'
    id: string
...
export type VideoDebateSpeakerRemovedSubscription = {
  __typename?: 'RootSubscriptionType'
  speakerRemoved?: { __typename?: 'SpeakerRemoved'; id: string } | null
}
...
export type VideoDebateStartAutomaticStatementsExtractionMutation = {
  __typename?: 'RootMutationType'
  startAutomaticStatementsExtraction?: { __typename?: 'Video'; id: string } | null
}
...
export type VideoDebateUpdateSubscriptionMutation = {
  __typename?: 'RootMutationType'
  updateSubscription?: {
    __typename?: 'NotificationsSubscription'
    id: string
...
export type StatementHistoryActionsQuery = {
  __typename?: 'RootQueryType'
  statementHistoryActions?: Array<{
    __typename?: 'UserAction'
    id: string
    type: string
    entity: string
...
export type EditVideoMutation = {
  __typename?: 'RootMutationType'
  editVideo?: { __typename?: 'Video'; id: string; unlisted: boolean } | null
}
...
export type ShiftStatementsMutation = {
  __typename?: 'RootMutationType'
  shiftStatements?: {
    __typename?: 'Video'
    id: string
