...
export const joinVideoDebateHistoryChannel = videoId => dispatch => (
  joinHistoryChannel(dispatch, VIDEO_DEBATE_HISTORY_CHANNEL,
...
export const joinStatementHistoryChannel = statementId => dispatch => (
  joinHistoryChannel(dispatch, STATEMENTS_HISTORY_CHANNEL,
...
export const revertVideoDebateUserAction = action => dispatch => {
  ...
  return SocketApi
    .push(VIDEO_DEBATE_HISTORY_CHANNEL, msg, {id: getEntityIDFromAction(action)})
