export default {
  ...
  resetPasswordRequestSuccess:
    'If an account is associated with this address, an email with a link to reset your password has been sent',
  resetPasswordSuccess: 'Password successfully changed',
  invitationOnlyTitle: 'Ask for an invitation',
  invitationOnlyBody:
    'You must have an invitation to create an account. To request one, please enter you email below.',
