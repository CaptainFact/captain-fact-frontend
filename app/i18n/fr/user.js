export default {
  ...
  resetPasswordRequestSuccess:
    "Si le compte existe, un e-mail avec un lien de réinitialisation vient d'être envoyé",
  resetPasswordSuccess: 'Le mot de passe a bien été changé',
  invitationOnlyTitle: 'Demander une invitation',
  invitationOnlyBody:
    'Vous devez avoir été invité pour créer un compte. Pour demander une invitation, entrez votre adresse e-mail ci-dessous.',
