export default {
  ...
  server: {
    ...
    invalid_invitation_token:
      "Votre code d'invitation est invalide ou a expiré",
    ...
    limit_reached:
      'Vous avez atteint votre limite quotidienne pour cette action',
    not_found:
    ...
    noInternet:
      'La connexion au serveur a échoué, essayez de rafraichir la page'
  },
  client: {
    ...
    notEnoughReputation:
      'Pas assez de réputation pour accéder à cette fonctionnalité',
    needReputation:
