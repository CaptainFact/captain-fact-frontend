export default {
  title: 'Erreur',
  crash:
    "😥 Nooooooon! Le site a planté. Ce c'est pas votre faute, vous n'avez rien fait de mal.",
  contactSupport: 'Contacter le support',
  addIssue: 'Ajouter un ticket sur Github',
  ...
  server: {
    ...
    limit_reached:
      'Vous avez atteint votre limite pour cette action, réessayez dans quelques minutes',
    not_found:
