export default {
  ...
  'server': {
    ...
    'authentication_failed': 'L\'authentification a échouée',
    ...
    'limit_reached': 'Vous avez atteind votre limite quotidienne pour cette action',
    'not_found': 'Cet élement semble ne pas exister, essayez de rafraichir la page si le problème persiste',
